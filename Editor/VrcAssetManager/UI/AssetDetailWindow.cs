...
namespace AMU.Editor.VrcAssetManager.UI
{
    public class AssetDetailWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            var transparentTex = MakeTex(2, 2, new Color(0, 0, 0, 0));
            ...
            var thinScrollbarUp = new GUIStyle(GUI.skin.verticalScrollbarUpButton)
            {
                ...
                margin = new RectOffset(0, 0, 0, 0),
                padding = new RectOffset(0, 0, 0, 0),
                normal = { background = transparentTex },
                active = { background = transparentTex },
                hover = { background = transparentTex },
                focused = { background = transparentTex },
                onNormal = { background = transparentTex },
                onActive = { background = transparentTex },
                onHover = { background = transparentTex },
                onFocused = { background = transparentTex }
            };
